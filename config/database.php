...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
        |--------------------------------------------------------------------------
        | FreeRadius External Database Connection
        |--------------------------------------------------------------------------
        |
        | This connection is used to communicate with the external FreeRadius
        | database for PPPoE authentication management.
        |
        */
        'radius' => [
            'driver' => 'mysql',
