    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div
            ...
            <div class="p-6">
                ...
                <div class="overflow-x-auto rounded-xl border border-gray-100 dark:border-gray-700/50">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700/50">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700/50">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $nasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors group">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-4 cursor-pointer"
                                            @click="showDetailModal = true; $wire.showNasDetails(<?php echo e($nas->id); ?>)">
                                            <div class="relative">
                                                <div
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nas->last_check): ?>
                                                    <div
                                                        class="absolute -bottom-1 -right-1 h-3 w-3 rounded-full border-2 border-white dark:border-gray-800 <?php echo e($nas->is_online ? 'bg-green-500' : 'bg-red-500'); ?>">
                                                    </div>
                                                <?php else: ?>
                                                    <div
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-col gap-1">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <code
                                                    class="text-xs font-mono text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700/50 px-1.5 py-0.5 rounded"><?php echo e($nas->ip_address); ?></code>
                                            </div>
                                            <div class="flex items-center gap-2">
                                                <span class="text-[10px] font-bold text-gray-400 uppercase w-8">Port</span>
                                                <code
                                                    class="text-xs font-mono text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700/50 px-1.5 py-0.5 rounded"><?php echo e($nas->api_port); ?></code>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-col gap-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nas->last_check): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nas->is_online): ?>
                                                    <span
                                                ...
                                                <span class="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5"
                                                    title="<?php echo e($nas->last_check->format('d M Y H:i:s')); ?>">
                                                    <?php echo e($nas->last_check->diffForHumans()); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nas->is_active): ?>
                                            <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button wire:click="checkSingleConnection(<?php echo e($nas->id); ?>)"
                                                ...
                                                wire:target="checkSingleConnection(<?php echo e($nas->id); ?>)">
                                                <svg class="w-4 h-4"
                                            ...
                                            <button @click="showDetailModal = true; $wire.showNasDetails(<?php echo e($nas->id); ?>)"
                                            ...
                                            <button @click="showFormModal = true; $wire.editNas(<?php echo e($nas->id); ?>)"
                                            ...
                                            <button @click="showDeleteModal = true; $wire.confirmDelete(<?php echo e($nas->id); ?>)"
                ...
                <!-- Pagination -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nasList->hasPages()): ?>
                    <div class="mt-6">
                        <?php echo e($nasList->links()); ?>
                ...
                <form wire:submit="save">
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
                            <?php echo e($editMode ? 'Update Perangkat NAS' : 'Tambah NAS Baru'); ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500 mt-1 block"><?php echo e($message); ?></span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                <input type="number" wire:model="api_port" placeholder="8728"
                                    class="block w-full px-3 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['api_port'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500 mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
                            ...
                            <div class="col-span-2 sm:col-span-1" x-data="{ show: false }">
                                ...
                                <div class="relative">
                                    <input :type="show ? 'text' : 'password'" wire:model="password"
                                        placeholder="<?php echo e($editMode ? 'Biarkan kosong jika tetap' : 'Password'); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-span-2" x-data="{ show: false }">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['secret'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500 mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse border-t border-gray-100 dark:border-gray-700/50">
                        <button type="submit" wire:loading.attr="disabled"
                            ...
                            <?php echo e($editMode ? 'Simpan Perubahan' : 'Buat NAS'); ?>
    ...
    <div x-show="showDetailModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nasDetailId): ?>
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="flex items-center gap-2">
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($nasDetail && $nasDetail['uptime'] ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'); ?>">
                                    <span
                                        class="w-1.5 h-1.5 rounded-full <?php echo e($nasDetail && $nasDetail['uptime'] ? 'bg-emerald-500' : 'bg-red-500'); ?> mr-1.5"></span>
                                    <?php echo e($nasDetail && $nasDetail['uptime'] ? 'Online' : 'Offline'); ?>
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 mb-6">
                            <nav class="-mb-px flex space-x-8">
                                <button wire:click="$set('activeTab', 'info')"
                                    class="<?php echo e($activeTab === 'info' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 hover:border-gray-300'); ?> whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm transition-colors">
                                    Info System
                                </button>
                                <button wire:click="$set('activeTab', 'servers')"
                                    class="<?php echo e($activeTab === 'servers' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 hover:border-gray-300'); ?> whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm transition-colors">
                                    Server Services
                                </button>
                            </nav>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'info'): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nasDetail): ?>
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white truncate">
                                            <?php echo e($nasDetail['identity']); ?></p>
                                    </div>
                                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        <p class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">
                                            Platform</p>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white truncate">
                                            <?php echo e($nasDetail['platform']); ?> / <?php echo e($nasDetail['board_name']); ?></p>
                                    </div>
                                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        <p class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">
                                            Version</p>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white truncate">
                                            <?php echo e($nasDetail['version']); ?></p>
                                    </div>
                                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        <p class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">
                                            Uptime</p>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white truncate">
                                            <?php echo e($nasDetail['uptime']); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="p-4 border border-gray-100 dark:border-gray-700/50 rounded-xl">
                                        <div class="flex justify-between items-center mb-2">
                                            ...
                                            <span class="text-xs font-bold text-indigo-600"><?php echo e($nasDetail['cpu_load']); ?>%</span>
                                        </div>
                                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                            <div class="bg-indigo-600 h-2 rounded-full"
                                                style="width: <?php echo e($nasDetail['cpu_load']); ?>%"></div>
                                        </div>
                                    </div>
                                    <!-- Memory -->
                                    <div class="p-4 border border-gray-100 dark:border-gray-700/50 rounded-xl">
                                        <div class="flex justify-between items-center mb-2">
                                            ...
                                            <span
                                                class="text-xs font-bold text-blue-600"><?php echo e(number_format($nasDetail['free_memory'] / 1024 / 1024, 1)); ?>MB
                                                Free</span>
                                        </div>
                                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                            <div class="bg-blue-600 h-2 rounded-full"
                                                style="width: <?php echo e($nasDetail['total_memory'] > 0 ? 100 - ($nasDetail['free_memory'] / $nasDetail['total_memory'] * 100) : 0); ?>%">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- HDD -->
                                    <div class="p-4 border border-gray-100 dark:border-gray-700/50 rounded-xl">
                                        <div class="flex justify-between items-center mb-2">
                                            ...
                                            <span
                                                class="text-xs font-bold text-amber-600"><?php echo e(number_format($nasDetail['free_hdd'] / 1024 / 1024, 1)); ?>MB
                                                Free</span>
                                        </div>
                                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                            <div class="bg-amber-600 h-2 rounded-full"
                                                style="width: <?php echo e($nasDetail['total_hdd'] > 0 ? 100 - ($nasDetail['free_hdd'] / $nasDetail['total_hdd'] * 100) : 0); ?>%">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div x-data="{ selected: [] }">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button wire:click="syncServers(<?php echo e($nasDetailId); ?>)"
                                ...
                                <div class="overflow-hidden border border-gray-100 dark:border-gray-700 rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $nasServerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $server): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="px-4 py-2">
                                                        <input type="checkbox" x-model="selected" value="<?php echo e($server->id); ?>"
                                                            class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <span
                                                            class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($server['type'] === 'pppoe' ? 'bg-blue-100 text-blue-800' : ($server['type'] === 'hotspot' ? 'bg-amber-100 text-amber-800' : 'bg-gray-100 text-gray-800')); ?>">
                                                            <?php echo e(strtoupper($server['type'])); ?>

                                                        </span>
                                                    </td>
                                                    <td class="px-4 py-2 text-sm text-gray-900 dark:text-gray-100 font-medium">
                                                        <?php echo e($server['name']); ?></td>
                                                    <td class="px-4 py-2 text-sm text-gray-500"><?php echo e($server['interface']); ?></td>
                                                    <td class="px-4 py-2 text-sm text-gray-500"><?php echo e($server['profile']); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                <tr>
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                ...
                                <p class="mt-2 font-bold text-red-600"><?php echo e(count($selectedServers)); ?> servers selected.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH D:\01 BEGE\99 DEVS\LARAVEL\SKNET\SKNET-CRM-NEW\01\resources\views/livewire/master-data/nas-manager.blade.php ENDPATH**/ ?>