    ...
    @close-modal.window="showFormModal = false; showConfirmationModal = false;">
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Hotspot Profile Manager')); ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-700/50">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-50 dark:divide-gray-700/60">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $profiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-all group">
                                        ...
                                        <td class="px-8 py-5 whitespace-nowrap">
                                            <div
                                                ...
                                                <?php echo e($profile->rate_limit ?? 'NO LIMIT'); ?>
                                        ...
                                        <td class="px-8 py-5 whitespace-nowrap">
                                            <div
                                                ...
                                                <?php echo e($profile->validity_value); ?> <?php echo e(strtoupper($profile->validity_unit)); ?>
                                        ...
                                        <td class="px-8 py-5 whitespace-nowrap">
                                            <div
                                                ...
                                                Rp <?php echo e(number_format($profile->price, 0, ',', '.')); ?></div>
                                        </td>
                                        <td class="px-8 py-5 whitespace-nowrap text-center">
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest <?php echo e($profile->is_active ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300' : 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300'); ?>">
                                                <span
                                                    class="w-1.5 h-1.5 rounded-full mr-1.5 <?php echo e($profile->is_active ? 'bg-emerald-500' : 'bg-rose-500'); ?>"></span>
                                                <?php echo e($profile->is_active ? 'Active' : 'Offline'); ?>

                                            </span>
                                        </td>
                                        <td class="px-8 py-5 whitespace-nowrap text-right">
                                            <div class="flex items-center justify-end space-x-2">
                                                <button @click="showFormModal = true; $wire.edit(<?php echo e($profile->id); ?>)"
                                                ...
                                                <button
                                                    @click="showConfirmationModal = true; $wire.triggerConfirm('delete', <?php echo e($profile->id); ?>, 'Hapus Profil?', 'Apakah Anda yakin ingin menghapus profil <?php echo e($profile->name); ?>?')"
            ...
            <div
                ...
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100 mb-4">
                        <?php echo e($isEdit ? 'Edit Profile' : 'Profile Voucher'); ?>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-[10px] text-gray-500 mt-1">Harus sama dengan nama profile di
                                    mikrotik</p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['mikrotik_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-3">
                                ...
                                <input type="number" wire:model="data_limit" <?php echo e($data_limit_unit === 'UNLIMITED' ? 'disabled' : ''); ?>
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-3">
                                ...
                                <input type="number" wire:model="time_limit" <?php echo e($time_limit_unit === 'UNLIMITED' ? 'disabled' : ''); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.checkbox','data' => ['id' => 'is_active','wire:model' => 'is_active']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'is_active','wire:model' => 'is_active']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'is_active','class' => 'ml-2','value' => ''.e(__('Active')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'is_active','class' => 'ml-2','value' => ''.e(__('Active')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" wire:click="<?php echo e($isEdit ? 'update' : 'store'); ?>"
...
</div><?php /**PATH D:\01 BEGE\99 DEVS\LARAVEL\SKNET\SKNET-CRM-NEW\01\resources\views/livewire/hotspot/profile-manager.blade.php ENDPATH**/ ?>