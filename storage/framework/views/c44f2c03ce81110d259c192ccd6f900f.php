<div x-data="{
                                        prefix: '<?php echo e($pppoePrefix); ?>',
                                        suffix: '<?php echo e($pppoeSuffix); ?>',
                                        length: <?php echo e($pppoePasswordLength); ?>,
            ...
            <!-- Header -->
             <?php $__env->slot('header', null, []); ?> 
                <h2 class="font-semibold text-2xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('Manajemen Langganan')); ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex flex-wrap gap-3">
                                ...
                                <div class="relative w-full sm:w-48 z-10" x-data="{
                                        open: false,
                                        statuses: <?php if ((object) ('filterStatuses') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('filterStatuses'->value()); ?>')<?php echo e('filterStatuses'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('filterStatuses'); ?>')<?php endif; ?>.live,
                                        options: [
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700/50">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                                            ...
                                            <div class="flex items-center">
                                                <div>
                                                    ...
                                                    <div class="text-xs font-medium text-gray-500 dark:text-gray-400">
                                                        <?php echo e($subscription->customer->customer_id); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                                <?php echo e($subscription->period_label); ?>

                                            </div>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                <?php echo e($subscription->period_start->format('d M')); ?> -
                                                <?php echo e($subscription->period_end->format('d M Y')); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-bold rounded-lg <?php echo e($subscription->status_color); ?>">
                                                <?php echo e($subscription->status_label); ?>

                                            </span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subscription->olt_id): ?>
                                                <div class="mt-1">
                                                    <span
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end gap-2">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($subscription->status, ['active', 'pending'])): ?>
                                                    <button type="button"
                                                        @click.stop="triggerConfirm({ action: 'toggleStatus', id: <?php echo e($subscription->id); ?>, title: 'Konfirmasi Isolir', message: 'Yakin ingin mengisolir (suspend) langganan ini? User akan terputus dari internet.' })"
                                                ...
                                                <?php elseif($subscription->status === 'suspended'): ?>
                                                    <button type="button"
                                                        @click.stop="triggerConfirm({ action: 'toggleStatus', id: <?php echo e($subscription->id); ?>, title: 'Konfirmasi Aktivasi', message: 'Yakin ingin mengaktifkan kembali langganan ini?' })"
                                                ...
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <button wire:click="editSubscription(<?php echo e($subscription->id); ?>)"
                                                    wire:loading.attr="disabled"
                                                    wire:target="editSubscription(<?php echo e($subscription->id); ?>)"
                                                    <?php if($subscription->status === 'pending'): ?> disabled <?php endif; ?>
                                                    class="p-2 rounded-lg text-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 dark:text-indigo-400 dark:hover:bg-indigo-900/30 dark:hover:text-indigo-300 transition-colors duration-200 disabled:opacity-30 disabled:cursor-not-allowed <?php echo e($subscription->status === 'pending' ? 'grayscale' : ''); ?>"
                                                    title="<?php echo e($subscription->status === 'pending' ? 'Menunggu pembayaran - Tidak dapat diedit' : 'Edit'); ?>">
                                                ...
                                                <button type="button"
                                                    @click.stop="triggerConfirm({ action: 'deleteSubscription', id: <?php echo e($subscription->id); ?>, title: 'Hapus Langganan?', message: 'Apakah Anda yakin ingin menghapus data langganan ini? Data yang dihapus tidak dapat dikembalikan.' })"
                                                ...
                                                <a href="<?php echo e(route('provisioning.script', $subscription->id)); ?>"
                                                    target="_blank"
                                                ...
                                                <!-- Sync Button -->
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subscription->pppoe_username && $subscription->status === 'active'): ?>
                                                    <button wire:click="manualSync(<?php echo e($subscription->id); ?>)"
                                                        wire:loading.attr="disabled"
                                                        wire:target="manualSync(<?php echo e($subscription->id); ?>)"
                                                        ...
                                                        <svg wire:loading.remove
                                                            wire:target="manualSync(<?php echo e($subscription->id); ?>)" class="w-5 h-5"
                                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                                d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                                        </svg>
                                                        <svg wire:loading wire:target="manualSync(<?php echo e($subscription->id); ?>)"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">
                                        <?php echo e($editMode ? 'Edit Langganan' : 'Langganan Baru'); ?>

                                    </h3>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        <?php echo e($editMode ? 'Perbarui informasi langganan pelanggan' : 'Buat paket berlangganan baru untuk pelanggan'); ?>
                                        ...
                                        <div class="mb-4 flex items-center justify-between">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$editMode): ?>
                                                <button type="button" @click="$wire.openCustomerModal()"
                                                    ...
                                                    <?php echo e($customer_id ? 'Ganti Pelanggan' : 'Pilih Pelanggan'); ?>
                                                ...
                                                <div class="flex items-start gap-4">
                                                    <div
                                                        ...
                                                        <span class="text-lg font-black text-indigo-700 dark:text-indigo-300">
                                                            <?php echo e(strtoupper(substr($customer_name, 0, 1))); ?>
                                                    ...
                                                    <div class="min-w-0">
                                                        ...
                                                        <div class="flex items-center gap-2 mt-1">
                                                            <span
                                                                ...
                                                                <?php echo e($customer_number); ?>

                                                            </span>
                                                        </div>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer_phone): ?>
                                                            <div
                                                                ...
                                                                <span class="font-medium"><?php echo e($customer_phone); ?></span>
                                                            </div>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer_address): ?>
                                                            <div
                                                                ...
                                                                <span
                                                                    class="font-medium line-clamp-2"><?php echo e($customer_address); ?></span>
                                                            </div>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                </div>
...
$message = $__bag->first($__errorArgs[0]); ?> <span
                                                    class="text-red-500 text-[10px] mt-2 block"><?php echo e($message); ?></span>
                                                <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
                                                class="text-red-500 text-[10px] text-center block mt-2"><?php echo e($message); ?></span>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <select wire:model.live="package_id"
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($pkg->id); ?>"><?php echo e($pkg->name); ?> -
                                                            <?php echo e($pkg->formatted_price); ?>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
                                                    class="text-red-500 text-[10px] mt-1 block"><?php echo e($message); ?></span>
                                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editMode && $original_package_id && $package_id && $package_id != $original_package_id): ?>
                                                                            <?php
                                                                            ...
                                                                            <div
                                                                                class="p-3 rounded-xl border transition-all duration-300
                                                                                                                                                                                                    <?php echo e($isUpgrade
                                                ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-800/40'
                                                : 'bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800/40'); ?>">
                                                                                <div class="flex items-center gap-2 mb-2">
                                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isUpgrade): ?>
                                                                                ...
                                                                                <div class="flex items-center justify-between text-xs">
                                                                                    <div>
                                                                                        <span class="text-gray-500 dark:text-gray-400 font-medium">Paket
                                                                                            saat ini:</span>
                                                                                        <span
                                                                                            class="font-bold text-gray-700 dark:text-gray-300 ml-1"><?php echo e($original_package_name); ?></span>
                                                                                        <span class="text-gray-400 ml-1">(Rp
                                                                                            <?php echo e(number_format($original_package_price, 0, ',', '.')); ?>)</span>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="flex items-center justify-between text-xs mt-1">
                                                                                    <div>
                                                                                        ...
                                                                                        <span
                                                                                            class="font-black ml-1 <?php echo e($isUpgrade ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'); ?>">
                                                                                            <?php echo e($isUpgrade ? '+' : '-'); ?>Rp
                                                                                            <?php echo e(number_format(abs($priceDiff), 0, ',', '.')); ?>
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input type="date" wire:model="period_start"
                                                        class="block w-full bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700/50 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-300 px-4 py-2.5">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['period_start'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="date" wire:model="period_end"
                                                        class="block w-full bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700/50 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-300 px-4 py-2.5">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['period_end'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <label
                                                        ...
                                                        Langganan *</label>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allowedSubscriptionType === 'both'): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <input type="text" readonly
                                                            value="<?php echo e($allowedSubscriptionType === 'prepaid' ? 'Prabayar' : 'Pascabayar'); ?>"
                                                    ...
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['subscription_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4"
                                                x-data="{
                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                     discount: <?php if ((object) ('discount') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('discount'->value()); ?>')<?php echo e('discount'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('discount'); ?>')<?php endif; ?>,
                                                                                                                                                                                                                                                                                                                                                                     installation_fee: <?php if ((object) ('installation_fee') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('installation_fee'->value()); ?>')<?php echo e('installation_fee'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('installation_fee'); ?>')<?php endif; ?>,
                                                                                                                                                                                                                                                                                                                                                                     tax: <?php if ((object) ('tax') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tax'->value()); ?>')<?php echo e('tax'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tax'); ?>')<?php endif; ?>,
                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                     isProrated: <?php if ((object) ('isProrated') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isProrated'->value()); ?>')<?php echo e('isProrated'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isProrated'); ?>')<?php endif; ?>,
                                                                                                                                                                                                                                                                                                                                                                     taxPercentage: <?php if ((object) ('taxPercentage') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('taxPercentage'->value()); ?>')<?php echo e('taxPercentage'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('taxPercentage'); ?>')<?php endif; ?>,
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number" x-model="installation_fee" @input="updateTotalOnly()"
                                                        step="1"
                                                        class="block w-full bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/50 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 px-4 py-2">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['installation_fee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number" x-model="tax" @input="updateTotalOnly()" step="1"
                                                        class="block w-full bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/50 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 px-4 py-2">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['tax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
                                        ...
                                        <div class="space-y-4">
                                            <div class="space-y-4">
                                                ...
                                                <div class="grid grid-cols-2 gap-4">
                                                    <div>
                                                        ...
                                                        <select wire:model="nas_id"
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->nasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($service_type, ['ppp', 'hotspot'])): ?>
                                                        <div
                                                            ...
                                                            <div>
                                                                <label
                                                                    ...
                                                                    <?php echo e($service_type === 'hotspot' ? 'Hotspot' : 'PPPoE'); ?></label>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span
                                                                    class="text-red-500 text-[10px]"><?php echo e($message); ?></span>
                                                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service_type === 'ppp'): ?>
                                                                <div class="mt-3">
                                                                    <label
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service_type === 'dhcp'): ?>
                                                        <div
                                                            class="space-y-3 p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-700/50 mb-4 transition-all duration-300">
                                                            <div>
                                                                <label
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                ...
                                                <div>
                                                    ...
                                                    <select wire:model="olt_id"
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->olts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $olt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($olt->id); ?>"><?php echo e($olt->name); ?>

                                                                (<?php echo e($olt->ip_address); ?>)
                                                            </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <select wire:model="coverage_point_id"
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->coveragePoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($point->id); ?>"><?php echo e($point->name); ?>

                                                                (<?php echo e($point->type_label); ?>)</option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div
                                ...
                                <button type="submit"
                                    ...
                                    <?php echo e($editMode ? 'Simpan Perubahan' : 'Proses Langganan'); ?>

                                </button>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editMode): ?>
                                    <button type="button"
                                        @click.stop="triggerConfirm({ action: 'terminateSubscription', id: <?php echo e($subscription_id); ?>, title: 'Berhenti Berlangganan?', message: 'Yakin ingin menghentikan langganan pelanggan ini? Akses internet akan dihentikan.' })"
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="px-8 pt-8 pb-4">
                    ...
                    <div
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $filteredCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="group hover:bg-white dark:hover:bg-gray-800 transition-all duration-200">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-xs text-gray-600 dark:text-gray-400 font-medium">
                                                <?php echo e($cust->phone ?? 'N/A'); ?>

                                            </div>
                                        </td>
                                        <td class="px-6 py-4 text-right">
                                            <button type="button" wire:click="selectCustomer(<?php echo e($cust->id); ?>)"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filteredCustomers instanceof \Illuminate\Pagination\LengthAwarePaginator && $filteredCustomers->hasPages()): ?>
                        <div class="mt-4 px-2">
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                                    <?php echo e($filteredCustomers->firstItem()); ?>–<?php echo e($filteredCustomers->lastItem()); ?> dari
                                    <?php echo e($filteredCustomers->total()); ?> pelanggan
                                </span>
                                <div class="flex items-center gap-1">
                                    
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filteredCustomers->onFirstPage()): ?>
                                        <span
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $filteredCustomers->getUrlRange(max(1, $filteredCustomers->currentPage() - 2), min($filteredCustomers->lastPage(), $filteredCustomers->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page == $filteredCustomers->currentPage()): ?>
                                            <span
                                                class="px-3 py-1.5 text-xs font-black text-white bg-indigo-600 rounded-lg shadow-sm"><?php echo e($page); ?></span>
                                        <?php else: ?>
                                            <button wire:click="gotoPage(<?php echo e($page); ?>, 'customerPage')"
                                                class="px-3 py-1.5 text-xs font-bold text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"><?php echo e($page); ?></button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                    
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filteredCustomers->hasMorePages()): ?>
...
</div><?php /**PATH D:\01 BEGE\99 DEVS\LARAVEL\SKNET\SKNET-CRM-NEW\01\resources\views/livewire/subscription/subscription-manager.blade.php ENDPATH**/ ?>